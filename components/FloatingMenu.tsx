  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed z-50 flex items-center bg-zinc-900/90 dark:bg-zinc-100/90 backdrop-blur-md rounded-full px-2 py-1 shadow-xl border border-white/10 dark:border-black/10 text-white dark:text-zinc-900 -translate-x-1/2 mt-2"
      >
